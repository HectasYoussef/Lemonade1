...
import com.youssefchouchene.lemonade.R
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        when(lemonadeState){
            SELECT->textAction.setText("click to select a lemone")
            SQUEEZE->textAction.setText("click to juicethe lemone")
            DRINK->textAction.setText("click to dring your lemonade")
            RESTART->textAction.setText("click to  start to game")
        }
        when(lemonadeState){
